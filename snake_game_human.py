...
class SnakeGame:
    ...
    def _is_collision(self):
        ...
        if (
            self.head.x < 0
            or self.head.x > self.w - BLOCK_SIZE
            or self.head.y < 0
    ...
    def _update_ui(self):
        ...
        pygame.draw.rect(
                self.display, GREEN1, pygame.Rect(self.snake[0].x, self.snake[0].y, BLOCK_SIZE, BLOCK_SIZE))
        pygame.draw.rect(
                self.display, GREEN2, pygame.Rect(self.snake[0].x + 4,self.snake[0].y + 4, 12, 12)
            )
